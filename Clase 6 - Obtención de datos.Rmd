---
title: "Clase 6 - Obtención de datos"
author: "Ciencia de datos en FSOC"
date: "16/9/2019"
...
_No es ideal:_ las bases de datos pueden contener información fragmentada o que hace difícil su utilización. Esto último puede solucionarse con “limpieza”, pero puede ser un trabajo complejo y que nos consume mucho tiempo. 
...
Para acceder a los sistemas de _Twitter_ necesitamos obtener una autorización. 
...
__timeline__ de un usuario a partir de la función `get_timeline()`
...
El __Lenguaje de Marcado de Hipertexto (HTML)__ es el código que se utiliza para estructurar y desplegar una página web y sus contenidos. Por ejemplo, sus contenidos podrían ser párrafos, una lista con viñetas, o imágenes y tablas de datos. 
...
Las _etiquetas de encierre_ pueden hacer de una palabra o una imagen un hipervínculo a otro sitio, se pueden cambiar palabras a cursiva, agrandar o achicar la letra, etc. Por ejemplo, tomemos la siguiente línea de contenido: 
...
^1^Tomado de <https://developer.mozilla.org/es/>
